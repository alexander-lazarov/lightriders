...
// InitServer network and return two channels:
// - the first one consumes directions from the client
// - the second one consumes board states and sends them to the client
